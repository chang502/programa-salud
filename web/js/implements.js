...
function deleteRec(rec) {    
     Ext.Msg.confirm("Implementos", "Esta Seguro de Eliminar el Registro?", function (id, value) {
                                            if (id === 'yes') {
                                                   Ext.Ajax.request({
                                        url: 'controller/implementos/delete',
                                        method: 'POST',
                                        jsonData: '{"id_implemento": "' + rec + '"}',
...
function editRec(rec) {    
    var recordMaterial = store_implementos.findRecord('id_implemento',rec);    
    ...
    var frmEdit = Ext.create({
        ...
        items: [{
                ...
                items: [
                    {
                        xtype: 'hiddenfield',
                        fieldLabel: 'Id Implemento',
                        name: 'id_implemento',
                        id: 'id_implemento',  
                        value: dataMaterial.id_implemento,
                        maxLength: 50,
                        enforceMaxLength: 50,
                        allowBlank: false
                    },
                ...
                items: [
                    ...
                    },
                    {
                                ...
                                handler: function () {
                                    ...
                                    if (form.isValid()) {
                                        ...
                                        Ext.Msg.confirm("Desea Guardar?", "Esta Seguro?", function (id, value) {
                                         ...
                                         Ext.Ajax.request({
                                        url: 'controller/implementos/create',
                                        method: 'POST',
                                        jsonData: data,
                                        success: function (f, g) {
                                            var resultado = eval('(' + f.responseText + ')');
                        ...
                        items: [{
                                ...
                                maxHeight: 250,
                                columns: [
                                    {text: 'Id Implemento', dataIndex: 'id_implemento', width: 100},
                                    ...
                                    {text: 'Estado', dataIndex: 'activo', width: 120, renderer: function(value){ if (value == true) { return 'Activo' } else { return 'Inactivo'}}},
                                    {
                                        ...
                                        items: [{
                                                ...
                                                handler: function (grid, rowIndex, colIndex) {
                                                    var rec = grid.getStore().getAt(rowIndex).get('id_implemento');
                                                    editRec(rec);
                                                }
                                            }, {
