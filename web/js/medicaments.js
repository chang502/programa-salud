...
var store_medicamentos = Ext.create('Ext.data.Store', {
    fields: ['id_medicamento', 'nombre', 'presentacion', 'activo', 'existencia', 'alerta'],
      proxy: {
        type: 'ajax',
...
function deleteRec(rec) {    
     Ext.Msg.confirm("Medicamentos", "Esta Seguro de Eliminar el Registro?", function (id, value) {
                                            if (id === 'yes') {
                                                               Ext.Ajax.request({
                                        url: 'controller/medicaments/delete',
                                        method: 'POST',
                                        jsonData: '{"id_medicamento": "' + rec + '"}',
                                        success: function (f, g) {
                                            var resultado = eval('(' + f.responseText + ')');
                                            if (resultado.success) {                                                                                               
                                                store_medicamentos.load();
...
function editRec(rec) {    
    var recordMaterial = store_medicamentos.findRecord('id_medicamento',rec);    
    ...
    var frmEdit = Ext.create({
        ...
        items: [{
                ...
                items: [
                    {
                        xtype: 'hiddenfield',
                        fieldLabel: 'Id Medicamento',
                        name: 'id_medicamento',
                        id: 'id_medicamento',  
                        value: dataMaterial.id_medicamento,
                        maxLength: 50,
                        enforceMaxLength: 50,
                        allowBlank: false
                    },
                    ...
                    {xtype: 'textfield',
                        ...
                        name: 'presentacion',
                        value: dataMaterial.presentacion,
                        maxLength: 50,
                        enforceMaxLength: 50,
                        allowBlank: false
                    },
        ...
        items: [{
                ...
                items: [
                    ...
                    },
                    {
                                ...
                                handler: function () {
                                    ...
                                    if (form.isValid()) {
                                        ...
                                        Ext.Msg.confirm("Desea Guardar?", "Esta Seguro?", function (id, value) {
                                         ...
                                         Ext.Ajax.request({
                                        url: 'controller/medicaments/create',
                                        method: 'POST',
                                        jsonData: data,
                                        success: function (f, g) {
                                            var resultado = eval('(' + f.responseText + ')');
                        ...
                        items: [{
                                xtype: 'grid',
                                store: store_medicamentos,
                                maxHeight: 250,
                                columns: [
                                    {text: 'Id Medicamento', dataIndex: 'id_medicamento', width: 100},
                                    ...
                                    {text: 'Estado', dataIndex: 'activo', width: 120, renderer: function(value){ if (value == true) { return 'Activo' } else { return 'Inactivo'}}},
                                    {
                                        ...
                                        items: [{
                                                ...
                                                handler: function (grid, rowIndex, colIndex) {
                                                    var rec = grid.getStore().getAt(rowIndex).get('id_medicamento');
                                                    editRec(rec);
                                                }
                                            }, {
