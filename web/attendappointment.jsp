<%-- 
    Document   : attendappointment
    Created on : Jul 18, 2018, 11:56:23 PM
    Author     : Andres
--%>
...
<html>
    <head>
        ...
        <script src="js/patienthistory_store.js" type="text/javascript"></script>
        <script src="js/patienthistory_panel.js" type="text/javascript"></script>
        <script src="js/attendappointment.js" type="text/javascript"></script>
